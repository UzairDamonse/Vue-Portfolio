<template>
  <div v-for="testimonial in testimonial" :key="testimonial.id" class="mx-3">
    <img id="testImg" class="my-4 pt-5" v-bind:src="testimonial.imgURL" />
...
* {
  color: var(--white);
  text-shadow: 0px 0px 20px #757674;
}
.testimonials {
  padding-top: 5rem;
  padding-bottom: 5rem;
